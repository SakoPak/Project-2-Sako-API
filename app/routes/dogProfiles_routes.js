...
router.get('/dogProfiles', requireToken, (req, res, next) => {
  Dog.find({owner: req.user.id})
    // .then(dog => {
    //   return dog.filter(profile => { return profile.owner === req.user.id })
    // })
    .then(dog => dog.map(dog => dog.toObject()))
    // respond with status 200 and JSON of the examples
    .then(dog => res.json({dog: dog}))
    // if an error occurs, pass it to the handler
    .catch(next)
})

// SHOW
// GET /dogProfiles/5a7db6c74d55bc51bdf39793
router.get('/dogProfiles/:id', requireToken, (req, res, next) => {
...
// CREATE
// POST /examples
router.post('/dogProfiles', requireToken, (req, res, next) => {
...
// UPDATE
// PATCH /dogProfiles/5a7db6c74d55bc51bdf39793
router.patch('/dogProfiles/:id', requireToken, removeBlanks, (req, res, next) => {
...
// DESTROY
// DELETE /dogProfiles/5a7db6c74d55bc51bdf39793
